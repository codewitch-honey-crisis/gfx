...
5. [Drawing](drawing.md)
    ...
    - 5.7 [SVGs](drawing.md#5.7)
    - 5.8 [Alpha blending](drawing.md#5.8)
      - 5.8.1 [Performance considerations](drawing.md#5.8.1)
      - 5.8.2 [Draw target considerations](drawing.md#5.8.2)
    - 5.9 [Suspend and resume](drawing.md#5.9)
    - 5.10 [Batching](drawing.md#5.10)
