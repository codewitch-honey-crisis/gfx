...
namespace gfx {
        ...
        struct color final {
                ...
                template<typename PixelType> const PixelType color<PixelType>::alice_blue;
        template<typename PixelType> const PixelType color<PixelType>::antique_white;
        template<typename PixelType> const PixelType color<PixelType>::aqua;
        template<typename PixelType> const PixelType color<PixelType>::aquamarine;
        template<typename PixelType> const PixelType color<PixelType>::azure;
        template<typename PixelType> const PixelType color<PixelType>::beige;
        template<typename PixelType> const PixelType color<PixelType>::bisque;
        template<typename PixelType> const PixelType color<PixelType>::black;
        template<typename PixelType> const PixelType color<PixelType>::blanched_almond;
        template<typename PixelType> const PixelType color<PixelType>::blue;
        template<typename PixelType> const PixelType color<PixelType>::blue_violet;
        template<typename PixelType> const PixelType color<PixelType>::brown;
        template<typename PixelType> const PixelType color<PixelType>::burly_wood;
        template<typename PixelType> const PixelType color<PixelType>::cadet_blue;
        template<typename PixelType> const PixelType color<PixelType>::chartreuse;
        template<typename PixelType> const PixelType color<PixelType>::chocolate;
        template<typename PixelType> const PixelType color<PixelType>::coral;
        template<typename PixelType> const PixelType color<PixelType>::cornflower_blue;
        template<typename PixelType> const PixelType color<PixelType>::cornsilk;
        template<typename PixelType> const PixelType color<PixelType>::crimson;
        template<typename PixelType> const PixelType color<PixelType>::cyan;
        template<typename PixelType> const PixelType color<PixelType>::dark_blue;
        template<typename PixelType> const PixelType color<PixelType>::dark_cyan;
        template<typename PixelType> const PixelType color<PixelType>::dark_goldenrod;
        template<typename PixelType> const PixelType color<PixelType>::dark_gray;
        template<typename PixelType> const PixelType color<PixelType>::dark_green;
        template<typename PixelType> const PixelType color<PixelType>::dark_khaki;
        template<typename PixelType> const PixelType color<PixelType>::dark_magenta;
        template<typename PixelType> const PixelType color<PixelType>::dark_olive_green;
        template<typename PixelType> const PixelType color<PixelType>::dark_orange;
        template<typename PixelType> const PixelType color<PixelType>::dark_orchid;
        template<typename PixelType> const PixelType color<PixelType>::dark_red;
        template<typename PixelType> const PixelType color<PixelType>::dark_salmon;
        template<typename PixelType> const PixelType color<PixelType>::dark_sea_green;
        template<typename PixelType> const PixelType color<PixelType>::dark_slate_blue;
        template<typename PixelType> const PixelType color<PixelType>::dark_slate_gray;
        template<typename PixelType> const PixelType color<PixelType>::dark_turquoise;
        template<typename PixelType> const PixelType color<PixelType>::dark_violet;
        template<typename PixelType> const PixelType color<PixelType>::deep_pink;
        template<typename PixelType> const PixelType color<PixelType>::deep_sky_blue;
        template<typename PixelType> const PixelType color<PixelType>::dim_gray;
        template<typename PixelType> const PixelType color<PixelType>::dodger_blue;
        template<typename PixelType> const PixelType color<PixelType>::firebrick;
        template<typename PixelType> const PixelType color<PixelType>::floral_white;
        template<typename PixelType> const PixelType color<PixelType>::forest_green;
        template<typename PixelType> const PixelType color<PixelType>::fuchsia;
        template<typename PixelType> const PixelType color<PixelType>::gainsboro;
        template<typename PixelType> const PixelType color<PixelType>::ghost_white;
        template<typename PixelType> const PixelType color<PixelType>::gold;
        template<typename PixelType> const PixelType color<PixelType>::goldenrod;
        template<typename PixelType> const PixelType color<PixelType>::gray;
        template<typename PixelType> const PixelType color<PixelType>::green;
        template<typename PixelType> const PixelType color<PixelType>::green_yellow;
        template<typename PixelType> const PixelType color<PixelType>::honeydew;
        template<typename PixelType> const PixelType color<PixelType>::hot_pink;
        template<typename PixelType> const PixelType color<PixelType>::indian_red;
        template<typename PixelType> const PixelType color<PixelType>::indigo;
        template<typename PixelType> const PixelType color<PixelType>::ivory;
        template<typename PixelType> const PixelType color<PixelType>::khaki;
        template<typename PixelType> const PixelType color<PixelType>::lavender;
        template<typename PixelType> const PixelType color<PixelType>::lavender_blush;
        template<typename PixelType> const PixelType color<PixelType>::lawn_green;
        template<typename PixelType> const PixelType color<PixelType>::lemon_chiffon;
        template<typename PixelType> const PixelType color<PixelType>::light_blue;
        template<typename PixelType> const PixelType color<PixelType>::light_coral;
        template<typename PixelType> const PixelType color<PixelType>::light_cyan;
        template<typename PixelType> const PixelType color<PixelType>::light_goldenrod_yellow;
        template<typename PixelType> const PixelType color<PixelType>::light_green;
        template<typename PixelType> const PixelType color<PixelType>::light_gray;
        template<typename PixelType> const PixelType color<PixelType>::light_pink;
        template<typename PixelType> const PixelType color<PixelType>::light_salmon;
        template<typename PixelType> const PixelType color<PixelType>::light_sea_green;
        template<typename PixelType> const PixelType color<PixelType>::light_sky_blue;
        template<typename PixelType> const PixelType color<PixelType>::light_slate_gray;
        template<typename PixelType> const PixelType color<PixelType>::light_steel_blue;
        template<typename PixelType> const PixelType color<PixelType>::light_yellow;
        template<typename PixelType> const PixelType color<PixelType>::lime;
        template<typename PixelType> const PixelType color<PixelType>::lime_green;
        template<typename PixelType> const PixelType color<PixelType>::linen;
        template<typename PixelType> const PixelType color<PixelType>::magenta;
        template<typename PixelType> const PixelType color<PixelType>::maroon;
        template<typename PixelType> const PixelType color<PixelType>::medium_aquamarine;
        template<typename PixelType> const PixelType color<PixelType>::medium_blue;
        template<typename PixelType> const PixelType color<PixelType>::medium_orchid;
        template<typename PixelType> const PixelType color<PixelType>::medium_purple;
        template<typename PixelType> const PixelType color<PixelType>::medium_sea_green;
        template<typename PixelType> const PixelType color<PixelType>::medium_slate_blue;
        template<typename PixelType> const PixelType color<PixelType>::medium_spring_green;
        template<typename PixelType> const PixelType color<PixelType>::medium_turquoise;
        template<typename PixelType> const PixelType color<PixelType>::medium_violet_red;
        template<typename PixelType> const PixelType color<PixelType>::midnight_blue;
        template<typename PixelType> const PixelType color<PixelType>::mint_cream;
        template<typename PixelType> const PixelType color<PixelType>::misty_rose;
        template<typename PixelType> const PixelType color<PixelType>::moccasin;
        template<typename PixelType> const PixelType color<PixelType>::navajo_white;
        template<typename PixelType> const PixelType color<PixelType>::navy;
        template<typename PixelType> const PixelType color<PixelType>::old_lace;
        template<typename PixelType> const PixelType color<PixelType>::olive;
        template<typename PixelType> const PixelType color<PixelType>::olive_drab;
        template<typename PixelType> const PixelType color<PixelType>::orange;
        template<typename PixelType> const PixelType color<PixelType>::orange_red;
        template<typename PixelType> const PixelType color<PixelType>::orchid;
        template<typename PixelType> const PixelType color<PixelType>::pale_goldenrod;
        template<typename PixelType> const PixelType color<PixelType>::pale_green;
        template<typename PixelType> const PixelType color<PixelType>::pale_turquoise;
        template<typename PixelType> const PixelType color<PixelType>::pale_violet_red;
        template<typename PixelType> const PixelType color<PixelType>::papaya_whip;
        template<typename PixelType> const PixelType color<PixelType>::peach_puff;
        template<typename PixelType> const PixelType color<PixelType>::peru;
        template<typename PixelType> const PixelType color<PixelType>::pink;
        template<typename PixelType> const PixelType color<PixelType>::plum;
        template<typename PixelType> const PixelType color<PixelType>::powder_blue;
        template<typename PixelType> const PixelType color<PixelType>::purple;
        template<typename PixelType> const PixelType color<PixelType>::red;
        template<typename PixelType> const PixelType color<PixelType>::rosy_brown;
        template<typename PixelType> const PixelType color<PixelType>::royal_blue;
        template<typename PixelType> const PixelType color<PixelType>::saddle_brown;
        template<typename PixelType> const PixelType color<PixelType>::salmon;
        template<typename PixelType> const PixelType color<PixelType>::sandy_brown;
        template<typename PixelType> const PixelType color<PixelType>::sea_green;
        template<typename PixelType> const PixelType color<PixelType>::sea_shell;
        template<typename PixelType> const PixelType color<PixelType>::sienna;
        template<typename PixelType> const PixelType color<PixelType>::silver;
        template<typename PixelType> const PixelType color<PixelType>::sky_blue;
        template<typename PixelType> const PixelType color<PixelType>::slate_blue;
        template<typename PixelType> const PixelType color<PixelType>::slate_gray;
        template<typename PixelType> const PixelType color<PixelType>::snow;
        template<typename PixelType> const PixelType color<PixelType>::spring_green;
        template<typename PixelType> const PixelType color<PixelType>::steel_blue;
        template<typename PixelType> const PixelType color<PixelType>::tan;
        template<typename PixelType> const PixelType color<PixelType>::teal;
        template<typename PixelType> const PixelType color<PixelType>::thistle;
        template<typename PixelType> const PixelType color<PixelType>::tomato;
        template<typename PixelType> const PixelType color<PixelType>::turquoise;
        template<typename PixelType> const PixelType color<PixelType>::violet;
        template<typename PixelType> const PixelType color<PixelType>::wheat;
        template<typename PixelType> const PixelType color<PixelType>::white;
        template<typename PixelType> const PixelType color<PixelType>::white_smoke;
        template<typename PixelType> const PixelType color<PixelType>::yellow;
        template<typename PixelType> const PixelType color<PixelType>::yellow_green;
