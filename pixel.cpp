...
int main() {
    ...
    printf("color<gsc8>::light_green.channel<0>() = %d\r\n",(int)color<gsc8>::light_green.channel<0>());
    ...
    printf("color<mono1>::light_green.channel<0>() = %d\r\n",(int)color<mono1>::light_green.channel<0>());
